        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex justify-center items-center h-full">
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-3xl shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <form action="/siswa/storepengumpulan" method="post" class="max-w-md mx-auto">
                        <h2 class="text-pretty text-black text-center">Data Pengumpulan</h2> <br><br>
                        {{ csrf_field() }}
                        <div class="container">
                            <div class="mb-5">
                            ...
                            <div class="mb-5">
                                <label for="base-input" name="TANGGAL" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">TANGGAL</label>
                                <input type="date" name="TANGGAL" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="required" placeholder="Masukan Tanggal">
                            </div>

...
<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex justify-center items-center h-full">
					...
					@foreach($siswa as $p)
                        <form action="/siswa/update" method="post" class="max-w-md mx-auto">
                            <h2 class="text-pretty text-black text-center">Edit Data Siswa</h2> <br><br>
                            {{ csrf_field() }}
                            <div class="container">
							<input type="hidden" name="id" value="{{ $p->NISN }}"> <br />
							<div class="mb-5">
                                    <label for="base-input" name="NISN" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NISN</label>
                                    <input type="text" name="NISN" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly value="{{ $p->NISN }}">
                                </div>
                                <div class="mb-5">
                                    <label for="base-input" name="Nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                                    <input type="text" name="Nama" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="required" value="{{ $p->Nama }}">
                                </div>
                                <div class="mb-5">
                                    <label for="base-input" name="absen" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Absen</label>
                                    <input type="number" name="absen" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $p->absen }}" required="required">
                                </div>
								<div class="mb-5">
                                <label for="base-input" name="kelas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelas</label>
								<select name="kelas" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="required">
                                        <option selected value="{{ $p->kelas }}">{{ $p->kelas }}</option>
                                        @foreach($opt as $a)
